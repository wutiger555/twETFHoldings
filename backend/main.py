...
# 導入擴展
from backend.extensions import cors, api
...
# 導入 API 路由
from backend.api.v1 import etf, stock, search, stats
...
def init_scheduler(app):
    """初始化定時任務"""
    try:
        from backend.tasks.scheduler import init_scheduler as start_scheduler
        start_scheduler()
